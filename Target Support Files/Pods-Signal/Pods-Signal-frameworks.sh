...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TwistedOakCollapsingFutures/TwistedOakCollapsingFutures.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/UnionFind/UnionFind.framework"
